...
var onCreatePost = function onCreatePost(event) {
  ...
  api.createPost(title, description).done(ui.createPostSuccess).fail(ui.createPostFail);
};
...
var createPost = function createPost(title, description) {
...
var createPostFail = function createPostFail(data) {
  // app.user = data.user;
  console.log(data);
};
